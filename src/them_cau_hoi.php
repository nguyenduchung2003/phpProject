           ...
           <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin: 20px 13%;">
                ...
                <div class="form-group">
                    ...
                    <option value="Điền" <?php echo (isset($_POST['dang_cau_hoi']) && $_POST['dang_cau_hoi'] == 'Điền') ? 'selected' : ''; ?>>Điền</option>
    <option value="CheckBox" <?php echo (isset($_POST['dang_cau_hoi']) && $_POST['dang_cau_hoi'] == 'CheckBox') ? 'selected' : ''; ?>>CheckBox</option>
    <!-- <option value="Select" <?php echo (isset($_POST['dang_cau_hoi']) && $_POST['dang_cau_hoi'] == 'Select') ? 'selected' : ''; ?>>Select</option> -->
                    </select>
                </div>
                ...
                <!-- <input name='da' type='text' class='form-control' placeholder='Nhập đáp án' value=""> -->
                  <input name='slda' type='number' class='form-control' placeholder='Nhập số lượng đáp án' value="<?php echo isset($_POST['slda']) ? $_POST['slda'] : '' ?>" >
...
// ......
                            ...
                            if (!$result) {
                                ...
                                if ($resultIds) {
                                    ...
                                    for ($i = 1; $i <= $soLuongDa; $i++) {
                                        ...
                                        $sql2 = "INSERT INTO dapan (dapan, dapandung, id_cauhoi) VALUES ('$dapAnValue', '$checkDapAnValue', '$lastId')";
               ...
               <?php
                   if (isset($_POST['btnSlDa'])) {
                    $soLuongDa = $_POST['slda'];
                    $typeQuestion = $_POST['dang_cau_hoi'];
                    if($typeQuestion == "Điền" && $soLuongDa != 1) {
                         echo('<div class="alert alert-warning text-center" role="alert">Câu hỏi điền có số lượng đáp án là 1 </div>');
                    }
                    else {
                         echo('<div class="alert alert-success text-center" role="alert">Các đáp án đúng sẽ được tick vào ô checkbox </div>');
                        for ($i = 1; $i <= $soLuongDa; $i++) {
 
                    //     echo '<form method="post"></form>';
                        echo '<input type="checkbox" name="check_dap_an_' . $i . '">'; 
